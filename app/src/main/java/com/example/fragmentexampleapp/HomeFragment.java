...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View firstFragment= inflater.inflate(R.layout.fragment_home, container, false);

        Button randomBt=firstFragment.findViewById(R.id.buttonRandom);
        Button factorial= firstFragment.findViewById(R.id.buttonFactorial);
        Button count= firstFragment.findViewById(R.id.buttonSum);
